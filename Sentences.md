...
- vagrant@magento2:/vagrant/source$ php bin/magento cache:status
Current status:
                        config: 1
                        layout: 1
                    block_html: 1
...
- vagrant@magento2:/vagrant/source$ php bin/magento indexer:reindex catalogrule_rule
Catalog Rule Product index has been rebuilt successfully in 00:00:11

# Module Status recently installed
- bin/magento module:status                                            # Status
- bin/magento module:enable J2t_Payplug --clear-static-content         # Enable
- bin/magento setup:upgrade                                            # Register
- bin/magento setup:di:compile                                         # Recompile
- bin/magento module:status

# rm -rf var/di var/cache var/generation/ var/page_cache/
# sudo bash -c 'echo > /var/log/apache2/error-site.log'
